...
while($row=mysql_fetch_array($resource)) {
           echo "<tr><td> <a href=\"articles.php?book_id=".$row[0]."\">".$row[1]."</a></td><td>".$row[2]."</td><td> ".$row[3]." </td><td>".$row[4]."</td><td><a href=\"articles.php?book_id=".$row[0]."\">view</a>  | <a href=\"put_archive.php?id=".$row[0]."\">archive</a> </td></tr>";
         }
         echo "</table>";
        ?>                 
