...
<head>
  ...
  <title>Project Tigom | Submission</title>
...
<!--.preloader-->
        ...
        <div class="row" >
            ...
            <div class="col-sm-10 wow fadeInLeft" data-wow-delay="400ms"><br>
              <legend style = "color: white">  
                <h1 class="head-text">Submission</h1>
              </legend>
            </div>
          </div>
    <br><br><br>
 ...
 <?php
         ...
         $query="SELECT book_id,title, author_name, genre, summary, source_link FROM author, book WHERE book.author_id = author.author_id and tag=0 and archive=0 order by book_id";
...
while($row=mysql_fetch_array($resource)) {
           echo "<tr><td> <a href=\"book.php?book_id=".$row[1]."\">".$row[1]."</a></td><td>".$row[2]."</td><td> ".$row[3]." </td><td>".$row[4]."</td><td><a href=\"approve.php?id=".$row[0]."\">Approve</a> | <a href=\"delete.php?id=".$row[0]."\">Delete</a> | <a href=\"articles.php?book_id=".$row[0]."\">view</a></td></tr>";
         }
         echo "</table>";
        ?>                 
