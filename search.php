  ...
  <section id="blog">
	...
	<div class="container">
		...
		<div class="col-sm-12 wow fadeInRight" data-wow-delay="400ms">
         <form action="search.php"d method="post">
<input class = "search-bar" id="search" type="text" name="search" placeholder="Search Book"/>
<button name"search" type="submit" class="button" id="search" value="search" >Search</button>
</form>
 ...
 <?php 
	...
	mysql_connect("localhost", "root",  "JAMES1995") or die ("Cannot Connect to the database!"); 
	mysql_select_db("tigom") or die ("Cannot select the database!"); 
	$output = '';
	if(isset($_POST['search'])) {
		$searchq = $_POST['search'];
		$searchq = preg_replace("#[^0-9a-z]#i","",$searchq);
	
		$query = mysql_query("SELECT DISTINCT book_id, title, author_name, genre, summary, source_link FROM  book, author WHERE  author.author_id = book.author_id  AND title LIKE '%$searchq%' group by book_id") or die("Could not search!");
...
echo "<table align=\"center\" border=\"0\" width=\"100%\"><tr><th>Title</th><th>Author</th><th>Genre</th><th>Description</th><th></th></tr>";
           ...
           $output =  "<tr><td> <a href=\"book.php?book_id=".$book_id."\">".$title."</a></td><td>".$author_name."</td><td> ".$genre." </td><td>".$summary."</td><td><a href=\"articles.php?book_id=".$book_id."\">view</a></td></tr>";
		   print($output);
         }
         echo "</table>";
		}
    ...
    <div class="wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
      <div class="footer-left">
        <div class="footer-logo">
          <a href="index.php"><img class="img-responsive" src="images/logoPTv2.png" style="width: 250px"></a>
        </div>
      </div>
